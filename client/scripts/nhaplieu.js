...
//
//
let createNewRow = function(x1, x2, x3, x4, x5, x6, x7, x8, x9, x10) {
				...
				if(ret.rights.includes("tongcuc")) {
					...
					for (let i = 0; i < ret.data.length; i++) {
						let r = createNewRow((i+1).toString(), ret.data[i].cccd, ret.data[i].ten, 
											ret.data[i].ngaysinh, ret.data[i].gioitinh, ret.data[i].quequan,
					...
					for (let i = 0; i < ret.data.length; i++) {
						let r = createNewRow((i+1).toString(), ret.data[i].cccd, ret.data[i].ten, ret.data[i].ngaysinh, ret.data[i].gioitinh, ret.data[i].quequan, ret.data[i].quequan, ret.data[i].dctamtru, ret.data[i].tongiao, ret.data[i].trinhdovh, ret.data[i].nghenghiep);
						tbl.appendChild(r);
					}
				}
				else {
